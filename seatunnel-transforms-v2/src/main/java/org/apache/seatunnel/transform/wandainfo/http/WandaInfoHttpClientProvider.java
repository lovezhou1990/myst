...
package org.apache.seatunnel.transform.wandainfo.http;
...
@Slf4j
public class WandaInfoHttpClientProvider implements AutoCloseable, Serializable {
    ...
    public WandaInfoHttpClientProvider(HttpParameter httpParameter) {
