...
public class BIZ_037_FSZLXK_ZY_COPY {

    public static void main(String[] args)
            throws FileNotFoundException, URISyntaxException, CommandException {
        String configurePath = args.length > 0 ? args[0] : "/examples/BIZ_037_FSZLXK_ZYCopy.conf";
...
//        clientCommandArgs.setJobName(Paths.get(configFile).getFileName().toString());
    ...
    public static String getTestConfigFile(String configFile)
        ...
        URL resource = BIZ_037_FSZLXK_ZY_COPY.class.getResource(configFile);
        if (resource == null) {
