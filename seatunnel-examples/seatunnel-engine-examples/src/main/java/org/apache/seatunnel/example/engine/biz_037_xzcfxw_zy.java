...
public class biz_037_xzcfxw_zy {

    public static void main(String[] args)
            throws FileNotFoundException, URISyntaxException, CommandException {
        String configurePath = args.length > 0 ? args[0] : "/examples/biz_037_xzcfxw_zy.conf";
...
//        clientCommandArgs.setJobName(Paths.get(configFile).getFileName().toString());
    ...
    public static String getTestConfigFile(String configFile)
        ...
        URL resource = biz_037_xzcfxw_zy.class.getResource(configFile);
        if (resource == null) {
