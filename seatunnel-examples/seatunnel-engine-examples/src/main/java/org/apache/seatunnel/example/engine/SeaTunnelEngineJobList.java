...
public class SeaTunnelEngineJobList {

    public static void main(String[] args)
            throws FileNotFoundException, URISyntaxException, CommandException {
        String configurePath = args.length > 0 ? args[0] : "/examples/wanda.conf";
...
//        clientCommandArgs.setJobName(Paths.get(configFile).getFileName().toString());
    ...
    public static String getTestConfigFile(String configFile)
        ...
        URL resource = SeaTunnelEngineJobList.class.getResource(configFile);
        if (resource == null) {
